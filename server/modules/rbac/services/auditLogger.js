...
async function logAudit({
  ...
  try {
    ...
    const statusColor = result === 'allowed' ? '\x1b[32mAllowed\x1b[0m' : '\x1b[31mDenied\x1b[0m';
    console.log(`[AUDIT] ${statusColor} | User: ${user || 'Guest'} | Action: ${action} | Module: ${module} | Route: ${method} ${route} | Reason: ${reason || 'N/A'}`);
