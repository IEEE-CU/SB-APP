...
- Name: tests\e2e.spec.ts >> IEEE SB-APP Full End-to-End Tests >> 5. Responsive Layout Checks (Mobile View)
- Location: tests\e2e.spec.ts:88:3
...
- text: ieee-sb-kengeri.org/dashboard
