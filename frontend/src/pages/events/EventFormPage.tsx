    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <form id="event-form" onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-surface rounded-xl border border-hairline p-6 space-y-4 shadow-sm">
            <h3 className="text-heading-3 font-bold text-ink flex items-center gap-2">
              <MapPin className="text-emerald-600" size={18} /> Date, Time & Venue
            </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  type="date"
                  {...register("date")}
                  className="w-full px-3 py-2 bg-surface border border-hairline rounded-lg text-body-sm text-ink focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
                />
              </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 bg-surface border border-hairline rounded-lg text-body-sm text-ink focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
              />
            </div>
          </div>
          ...
          <div className="bg-surface rounded-xl border border-hairline p-6 space-y-4 shadow-sm">
            <div className="flex items-center justify-between">
              <h3 className="text-heading-3 font-bold text-ink flex items-center gap-2">
                <Users className="text-indigo-600" size={18} /> Key Speakers & Mentors
              </h3>
              <button
                type="button"
            ...
            <div className="space-y-3">
              {speakers.map((sp, i) => (
                <div key={i} className="p-3.5 bg-canvas-soft rounded-lg border border-hairline grid grid-cols-1 sm:grid-cols-3 gap-3 items-center">
                  <input
                    placeholder="Speaker Name"
                    value={sp.name}
                    onChange={(e) => handleSpeakerChange(i, "name", e.target.value)}
                    className="px-3 py-1.5 bg-surface border border-hairline rounded text-body-sm text-ink focus:outline-none"
                  />
                  <input
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-full px-3 py-1.5 bg-surface border border-hairline rounded text-body-sm text-ink focus:outline-none"
                    />
                    {speakers.length > 1 && (
                      <button
                        type="button"
        ...
        <div className="space-y-6">
          ...
          <div className="bg-surface rounded-xl border border-hairline p-5 shadow-sm space-y-3">
            ...
            <div className="p-3 rounded-lg bg-canvas-soft border border-hairline text-body-xs font-mono text-ink overflow-hidden break-all">
          ...
          <div className="bg-surface rounded-xl border border-hairline p-5 shadow-sm space-y-3">
            ...
            <select
              {...register("status")}
              className="w-full px-3 py-2 bg-surface border border-hairline rounded-lg text-body-sm font-semibold text-ink focus:outline-none focus:ring-2 focus:ring-primary/30"
            >
